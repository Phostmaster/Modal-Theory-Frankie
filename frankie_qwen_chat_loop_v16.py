...
- HARD BAN: never mention cat, kettle, hoodie, window, fence, garden, stretch, jump, meow, tail, wink
...
def main():
    print("🚀 Starting v16 Qwen-as-user chat with Frankie...")
    print("   (No cat/kettle/hoodie loops — fresh topics only!)")
    ...
    with open(LOG_FILE, "a", encoding="utf-8") as log:
        log.write(f"\n=== NEW SESSION v16 - {time.strftime('%Y-%m-%d %H:%M:%S')} ===\n\n")
        turn = 0
        try:
