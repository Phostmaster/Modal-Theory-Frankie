        ...
        try:
            while turn < MAX_TURNS:
                ...
                try:
                    ...
                    # === STRONGER RECALL BOOST (the magic whisper) ===
...
Answer directly and factually using only the details from that image. 
Be short and clear. Do not ask questions back. Do not be poetic.
